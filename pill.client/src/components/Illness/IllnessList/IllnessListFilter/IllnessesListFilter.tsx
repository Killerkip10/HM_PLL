...
export const IllnessListFilterComponent = ({ handleSubmit, array, symptoms }) => {
	const handleAddSymptom = useCallback(() => array.push(FORM_FIELDS.SYMPTOMS, 1), [array]);

	return (
		<form onSubmit={handleSubmit}>
			<RFields.Input name={FORM_FIELDS.NAME} />
			<FieldArray name={FORM_FIELDS.SYMPTOMS} component={FilterSymptomsList} symptoms={symptoms} />
